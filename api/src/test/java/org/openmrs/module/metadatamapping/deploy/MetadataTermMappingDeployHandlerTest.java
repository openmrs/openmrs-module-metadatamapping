...
public class MetadataTermMappingDeployHandlerTest extends BaseModuleContextSensitiveTest {
	...
	public void integration() {
		...
		deployService.installObject(metadataTermMapping(source, "code", "Location.class", "metadata-uuid", "term-uuid"));
		...
		Assert.assertThat(created.getMetadataClass(), is("Location.class"));
		...
		deployService.installObject(metadataTermMapping(source, "updated-code", "Concept.class", "updated-metadata-uuid",
		    "term-uuid"));
		...
		Assert.assertThat(created.getMetadataClass(), is("Concept.class"));
		...
		deployService.installObject(metadataTermMapping(source, "unretired-code", "Location.class",
