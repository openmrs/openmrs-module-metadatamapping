...
# Metadata Mapping OWA

This repository contains the Metadata Mapping OpenMRS Open Web App.
...
This will create a file called `metadatamapping.zip` file in the `dist` directory,
