 ...
 */
// generated on 2016-07-27 using generator-openmrs-owa 0.3.0
'use strict';
...
const THIS_APP_ID = 'metadatamapping';
...
var getConfig = function () {
	  ...
	  try {
	    ...
	    config = {
	      ...
	      'APP_ENTRY_POINT': 'http://localhost:8080/openmrs/owa/metadatamapping/index.html'
	    };
...
var webpackConfig = {
  quiet: false,
  entry: {
	  app : `${__dirname}/app/js/metadatamapping.js`,
	  css: `${__dirname}/app/css/metadatamapping.css`,
	  vendor : [
	        	 'angular',
